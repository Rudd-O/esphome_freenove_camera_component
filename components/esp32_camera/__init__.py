...
CONF_FRAMEBUFFER_IN_PSRAM = "framebuffer_in_psram"
...
CONFIG_SCHEMA = cv.ENTITY_BASE_SCHEMA.extend(
    {
        ...
        # pin assignment
        cv.Optional(CONF_FRAMEBUFFER_IN_PSRAM, default=True): cv.boolean,
...
SETTERS = {
    CONF_FRAMEBUFFER_IN_PSRAM: "set_framebuffer_in_psram",
    # pin assignment
